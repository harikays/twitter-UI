      ...
      <div class="lg:w-full relative">
        <button @click="dropdown = true" class="flex items-center w-full hover:bg-lightblue rounded-full p-2 focus:outline-none">
          ...
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight"> Syakirah Shah </p>
            <p class="text-sm leading-tight"> @harikaysss </p>
          </div>
        ...
        <div v-for="tweet in tweets" class="w-full p-4 border-b hover:bg-lighter flex">
          ...
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold"> Syakirah Shah </p>
              <p class="text-sm text-dark ml-2"> @harikaysss </p>
...
export default {
  ...
  data() {
    return {
      ...
      dropdown: false,
      trending: [
        {top: 'Trending in Malaysia', title: 'Karen', bottom: 'Trending with: Karen Misbehaving'},
        {top: 'Music', title: 'junhoe', bottom: '135K Tweets'},
        {top: 'Fashion', title: 'Dior', bottom: '40k tweets'},
        {top: 'Trending in Malaysia', title: 'KLCC', bottom: '40k tweets'},
        {top: 'K-pop Trending', title: 'MC JENO', bottom: '25.4k tweets'},
      ],
      friends: [
        {src: 'ellyyy.jpg', name: 'Elly', handle: '@thisisElly'},
        {src: 'boyyy.jpg', name: 'Boy Aiman', handle: '@theboy'},
        {src: 'emyyy.jpg', name: 'Emy Hana', handle: '@Emysss'}
      ],
      following: [
        {src: 'ellyyy.jpg', name: 'Elly', handle: '@thisisElly', time: '20 min', tweet: 'Undergrad really was the best years. Living young wild and free. And broke af but somehow we made the best of it!', comments: '1,000', retweets: '550', like: '1,000,003'},
        {src: 'boyyy.jpg', name: 'Boy Aiman', handle: '@theboy', time: '55 min', tweet: 'My toxic trait is feeling unwanted and removing myself first so I dont feel rejected', comments: '2,030', retweets: '50', like: '20,003'},
        {src: 'ellyyy.jpg', name: 'Elly', handle: '@thisisElly', time: '1.4 hr', tweet: 'If tomorrow doesnt look like what I planned it to be, I will still be grateful & learn to trust that things will still turn out fine.', comments: '100,000', retweets: '1,000,002', like: '5,000,003'},
        {src: 'ellyyy.jpg', name: 'Elly', handle: '@thisisElly', time: '1.4 hr', tweet: 'Cannot wait to meet you', comments: '100,500', retweets: '1,000,032', like: '5,000,103'}
      ],
      tweets: [
